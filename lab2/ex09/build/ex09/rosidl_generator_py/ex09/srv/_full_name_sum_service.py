...
class Metaclass_FullNameSumService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ex09')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FullNameSumService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ex09.srv import _full_name_sum_service
...
class FullNameSumService(metaclass=Metaclass_FullNameSumService):
    from ex09.srv._full_name_sum_service import FullNameSumService_Request as Request
    from ex09.srv._full_name_sum_service import FullNameSumService_Response as Response
