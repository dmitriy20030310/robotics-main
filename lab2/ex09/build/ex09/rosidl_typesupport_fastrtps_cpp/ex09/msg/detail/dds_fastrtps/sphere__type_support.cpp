...
#include "ex09/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ex09::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ex09::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ex09::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
