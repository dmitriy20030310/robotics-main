...
#include "ex09/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ex09::msg::Num & ros_message,
...
{
  auto typed_message =
    static_cast<const ex09::msg::Num *>(
    untyped_ros_message);
...
{
  return &ex09::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex09, msg, Num)() {
  return &ex09::msg::typesupport_fastrtps_cpp::_Num__handle;
}
