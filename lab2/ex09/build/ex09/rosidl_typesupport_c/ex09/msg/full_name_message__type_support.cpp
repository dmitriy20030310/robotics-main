...
static const _FullNameMessage_type_support_symbol_names_t _FullNameMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ex09, msg, FullNameMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ex09, msg, FullNameMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ex09, msg, FullNameMessage)() {
  return &::ex09::msg::rosidl_typesupport_c::FullNameMessage_message_type_support_handle;
}
