...
#include "ex09/msg/detail/full_name_message__rosidl_typesupport_fastrtps_c.h"
...
using _FullNameMessage__ros_msg_type = ex09__msg__FullNameMessage;
...
size_t get_serialized_size_ex09__msg__FullNameMessage(
  const void * untyped_ros_message,
...
static uint32_t _FullNameMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ex09__msg__FullNameMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ex09
size_t max_serialized_size_ex09__msg__FullNameMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ex09__msg__FullNameMessage;
    is_plain =
      (
...
static size_t _FullNameMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ex09__msg__FullNameMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ex09, msg, FullNameMessage)() {
